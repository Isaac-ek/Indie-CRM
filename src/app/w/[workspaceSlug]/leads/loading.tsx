        ...
        <div className="grid gap-6 lg:grid-cols-[19rem_minmax(0,1fr)]">
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] bg-white/80 p-6 shadow-[0_30px_100px_rgba(15,23,42,0.12)]">
              ...
              <div className="mt-4 h-12 w-80 rounded bg-slate-200" />
              <div className="mt-4 h-5 w-full rounded bg-slate-200" />
              <div className="mt-2 h-5 w-2/3 rounded bg-slate-200" />
            </div>
            <div className="h-56 rounded-[1.9rem] bg-white/80 shadow-[0_24px_80px_rgba(148,163,184,0.16)]" />
            <div className="space-y-4">
              <div className="h-72 rounded-[1.85rem] bg-white/80 shadow-[0_24px_80px_rgba(148,163,184,0.16)]" />
              <div className="h-72 rounded-[1.85rem] bg-white/80 shadow-[0_24px_80px_rgba(148,163,184,0.16)]" />
            </div>
          </div>
        </div>
